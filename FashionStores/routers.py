...
#         if model._meta.app_label == 'FashionStores':
#             return 'store_db'
#         return None
#
...
#         if obj1._meta.app_label == 'FashionStores' and obj2._meta.app_label == 'FashionStores':
#             return True
#         # No opinion if neither object is in the Example app (defer to default or other routers).
#         elif 'FashionStores' not in [obj1._meta.app_label, obj2._meta.app_label]:
#             return None
#
...
class StoreRouter:
    ...
    """
    route_app_labels = {'admin', 'auth', 'contenttypes', 'sessions', 'FashionStores'}
