...
class MenFashionScrapper(shopify):
    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(MenFashionScrapper, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def GetProductUrls(self, homePageResponse):
        ...
        topCategoryNodes = homePageResponse.xpath(
            "//ul[contains(@class,'site-navigation')]/li[a[contains(text(),'PANTS') or contains(text(),'MORE')]]")
        for topCategoryNode in topCategoryNodes:
            ...
            categoryNodes = topCategoryNode.xpath(
                "./ul/li/a[contains(text(),'Dress') or contains(text(),'Suits')]")
