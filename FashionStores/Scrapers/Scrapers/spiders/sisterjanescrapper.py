...
class SisterJaneScrapper(shopify):
    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(SisterJaneScrapper, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def GetProductUrls(self, homePageResponse):
        ...
        topCategoryNodes = homePageResponse.xpath(
            "//ul[contains(@class,'site-navigation')]/li/a[contains(b/text(),'NEW') or contains(text(),'Dress')]")
        for topCategoryNode in topCategoryNodes:
            try:
                topCategoryTitle = topCategoryNode.xpath("./b/text()").get().strip()
            except:
    ...
    def GetProducts(self, response):
        ...
        if (re.search('NEW IN', categoryAndName, re.IGNORECASE)) and not \
                re.search(r'\b((shirt(dress?)|jump(suit?)|dress|dungarees|gown|suit|caftan)(s|es)?)\b', categoryAndName,
                          re.IGNORECASE):
    ...
    def GetSelectedColor(self, response):
        return response.xpath(
            "//div[contains(@class,'variant-wrapper') and contains(label/text(),'Color')]/fieldset/div/label/text()").get().strip()
