...
class FlynnskyeScrapper(shopify):
    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(FlynnskyeScrapper, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def GetProductUrls(self, homePageResponse):
        ...
        topCategoryNodes = homePageResponse.xpath(
            "//ul[contains(@class,'HorizontalList')]/li[a[contains(text(),'Shop') or contains(text(),'Dresses')]]")
        for topCategoryNode in topCategoryNodes:
            ...
            CategoryNodes = topCategoryNode.xpath(
                "./div/ul/li/a[contains(text(),'Dresses') or contains(text(),'Jumpers') or contains(text(),'Maxi') or contains(text(),'Midi') or contains(text(),'Mini')]")
    ...
    def listing(self, categorylink, category):
        ...
        product_list = categoryLinkResponse.xpath(
            "//div[contains(@class,'ProductItem__Wrapper')]/a[contains(@class,'ProductItem__ImageWrapper')]/@href").extract()
