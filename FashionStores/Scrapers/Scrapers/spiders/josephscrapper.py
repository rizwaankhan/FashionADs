...
class JosephScrapper(Spider_BaseClass):
    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(JosephScrapper, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def GetProductUrls(self, homePageResponse):
        ...
        topCategoryNodes = homePageResponse.xpath(
            "//div[contains(@class,'o-layout__item')][span/a[text()='Clothing' or text()='Sale']]")
        for topCategoryNode in topCategoryNodes:
            topCategoryTitle = topCategoryNode.xpath("./span/a/text()").get().strip()
            topCategorylink = topCategoryNode.xpath("./span/a/@href").get()
