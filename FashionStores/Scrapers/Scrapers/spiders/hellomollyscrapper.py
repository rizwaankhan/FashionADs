...
class HelloMollyScrapper(shopify):
    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(HelloMollyScrapper, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def GetProducts(self, response):
        ...
        if (re.search('New', categoryAndName, re.IGNORECASE)) and not \
