...
class ClubMonacoScrapper(Spider_BaseClass):
    ...
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(ClubMonacoScrapper, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def GetProductUrls(self, homePageResponse):
        ...
        topCategoryNodes = homePageResponse.xpath(
            "//ul[contains(@class,'level-1')]/li[a[contains(text(),'Women') or contains(text(),'Men')]]")
        for topCategoryNode in topCategoryNodes:
            ...
            categoryNodes = topCategoryNode.xpath(
                "./div[@class='level-2']/div/ul/li[span[contains(text(),'Clothing')]]")
            for categoryNode in categoryNodes:
                ...
                subCategoryNodes = categoryNode.xpath(
                    "/div[@class='level-3']/ul/li[a[contains(text(),'Clothing')]]/following-sibling::li/a[contains(text(),'Dress') or contains(text(),'Shirts') or contains(text(),'Pant')]")
