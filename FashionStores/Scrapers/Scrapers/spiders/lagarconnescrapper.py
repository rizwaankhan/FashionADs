...
class LaGarconneScrapper(shopify):
    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(LaGarconneScrapper, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def GetProductUrls(self, homePageResponse):
        ...
        topCategoryNodes = homePageResponse.xpath(
            "//nav[contains(@class,'lg-filter-list-desktop')]/ul/li/a[contains(text(),'Clothing') or contains(text(),'New Arrivals')]")
        for topCategoryNode in topCategoryNodes:
            ...
            categoryNodes = topCategoryLinkResponse.xpath(
                "//div[@class='lg-mr-auto']/ul/li/a[contains(text(),'Dress') or contains(text(),'Clothing') or contains(text(),'Jumpsuit') or contains(text(),'Swimwear')]")
    ...
    def listing(self, categorylink, category):
        ...
        product_list = categoryLinkResponse.xpath("//h3[@class='lg-product-list-item-title']/a/@href").extract()
    ...
    def GetProducts(self, response):
        ...
        if (re.search(r'\b' + 'new arrival' + r'\b', categoryAndName, re.IGNORECASE)) and not \
