...
class ivyandleoScrapper(shopify):
    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(ivyandleoScrapper, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def GetProductUrls(self, homePageResponse):
        ...
        topCategoryNodes = homePageResponse.xpath(
            "//nav[contains(@class,'Header__MainNav')]/ul/li[a[contains(text(),'new') or contains(text(),'Clothing')]]")
        for topCategoryNode in topCategoryNodes:
            ...
            categoryNodes = topCategoryNode.xpath(
                "./div/div/div[a[contains(text(),'dress')]]")
    ...
    def listing(self, categorylink, category):
        ...
        product_list = categoryPageResponse.xpath(
            "//h2[contains(@class,'ProductItem__Title Headin')]/a/@href").extract()
