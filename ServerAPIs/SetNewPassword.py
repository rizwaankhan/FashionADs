...
def setNewPassword(request):
    ...
    try:
        user = Users.objects.get(id=userJson['id'])
        if request.method == 'POST' and user.password == userJson['password']:
            context = {"data": {
            },
                "Status": False,
            ...
            try:
                ...
                send_mail(html=passwordRestHtml, text='', subject='Password Reset Confirmation',
                          from_email='',
