class ServerRouter(object):
    ...
    def db_for_read(self, model, **hints):
        ...
        if model._meta.app_label == 'ServerAPIs':
            return 'server_db'
        return None
    ...
    def allow_relation(self, obj1, obj2, **hints):
        ...
        if obj1._meta.app_label == 'ServerAPIs' and obj2._meta.app_label == 'ServerAPIs':
            return True
        # No opinion if neither object is in the Example app (defer to default or other routers).
        elif 'ServerAPIs' not in [obj1._meta.app_label, obj2._meta.app_label]:
            return None
